		...
		<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
			...
			<div class="d-flex align-items-center flex-wrap mr-2">
				...
				<div class="d-flex align-items-center" id="kt_subheader_search">
					<span class="text-dark-50 font-weight-bold" id="kt_subheader_total"><?php echo $all_orders_count; ?> Total</span>
					<?php /* <form class="ml-5">
			...
			<div class="card card-custom">
				...
				<div class="card-header flex-wrap border-0 pt-6 pb-0">
					...
					<div class="card-toolbar">
						...
						<!--end::Dropdown-->
						<!--begin::Button-->
						<a href="<?php echo BASE_URL .'/admin/users/add'; ?>" class="btn btn-primary font-weight-bolder">
						<span class="svg-icon svg-icon-md">
				...
				<div class="card-body">
					<!--begin: Datatable-->
					<div class="datatable datatable-bordered datatable-head-custom" id="wad_admin_datatable_orders"></div>
					<!--end: Datatable-->
				</div>
				<!--end::Body-->
			</div>
