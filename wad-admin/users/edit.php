													...
													<div class="card card-custom card-stretch">
														...
														<div class="card-header py-3">
															...
															<div class="card-toolbar">
																...
																<a class="btn btn-secondary" href="<?php echo BASE_URL; ?>/admin?action=sign_in_as_user_using_admin&user=<?php echo $user['spp_id']; ?>">Sign in as user</a>
															</div>
														</div>
														<!--end::Header-->
														<!--begin::Body-->
														<div class="card-body">
															...
															<div class="form-group row">
																<label class="col-xl-3 col-lg-3 col-form-label">Weekly Quota</label>
																<div class="col-lg-9 col-xl-6">
