...
function wad_working_orders_table($action=null){
					...
					<td>
						<div class="d-flex w-100">
							<div class="">
								...
								<br />
								<span class="popover-need-help" data-html="true" data-container="body" data-offset="" data-toggle="popover" data-trigger="click" data-placement="top" data-content="If you have questions or need clarification on your article, please message a team member in the order details thread. In the case you need to reject the assignment, <a href='<?php echo BASE_URL; ?>?action=writer_reject_working_order&order=<?php echo $order_id; ?>&employee=<?php echo wad_get_current_user('spp_id');?>'>CLICK HERE</a>. Please remember only to reject in the case of emergency once you've accepted an assignment."><a href="javascript:void(0)" class="popover-need-help-trigger" style="color:#3699ff">Need Help?</a></span>
							</div>
							<?php /* <div>
