...
?>
					<!--begin::Footer-->
					<?php /* <div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
						<!--begin::Container-->
		...
		<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
			...
			<div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
				<h3 class="font-weight-bold m-0"><?php echo $role; ?> Profile</h3>
			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					<div class="symbol symbol-100 mr-5">
						<?php /* <div class="symbol-label" style="background-image:url('<?php echo BASE_URL; ?>/assets/media/users/300_21.jpg')"></div>
						<i class="symbol-badge bg-success"></i> */ ?>
						<span class="symbol-label font-size-h1 font-weight-bold"><?php echo $name[0]; ?></span>
					</div>
					<div class="d-flex flex-column">
						<div class="font-weight-bold font-size-h5 text-dark-75"><?php echo $name; ?></div>
						<div class="text-muted mt-1"><?php echo $role; ?></div>
						<div class="navi mt-2">
							...
							<a href="<?php echo BASE_URL; ?>/profile" class="btn btn-sm btn-primary font-weight-bolder py-2 px-5">Profile</a>
							<?php if( !isset($_COOKIE["wad_admin_logged_in_as_user"]) ): ?>
							<a id="wad-signout" href="javascript:;" class="btn btn-sm btn-light-danger font-weight-bolder py-2 px-5">Sign Out</a>
							<?php endif; ?>
						</div>
					</div>
				</div>
				<?php if( is_admin() ): ?>
					...
					<div class="">
						<h3>Email Counter</h3>
						Yesterday: <?php echo wad_get_email_counter('yesterday'); ?><br />
						Today: <?php echo wad_get_email_counter(); ?><br />
					</div>
				<?php endif; ?>
				...
				<?php if( isset($_COOKIE["wad_admin_logged_in_as_user"]) ): ?>
					<div class="separator separator-dashed mt-8 mb-5"></div>
					<div>
						<a href="<?php echo BASE_URL; ?>?action=back_to_admin">Back to admin</a>
					</div>
				<?php endif; ?>
		...
		<!-- end::User Panel-->
		<!--begin::Quick Cart-->
		<?php /* <div id="kt_quick_cart" class="offcanvas offcanvas-right p-10">
			<!--begin::Header-->
	...
	<div class="modal fade modal-order_complete" id="modal-order-complete" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
			<div class="modal-content">
				<form method="post" id="frm-order-complete">
				<div class="modal-header">
					<h5 class="modal-title"></h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Cancel">
						<i aria-hidden="true" class="ki ki-close"></i>
				...
				<div class="modal-footer">
					<button class="btn btn-danger font-weight-bold" data-dismiss="modal">STILL WRITING</button>
					<button class="btn btn-success btn-success2 font-weight-bold mb-1 btn-editor-confirm-submit_editing_order">CONFIRM and SEND</button>
				</div>
				</form>
			</div>
		</div>
	</div>
	<div class="justify-content-center position-fixed w-100 h-100 bg-light-o-100 modal-order_complete-loader d-none">
		<div class="align-self-center"><div class="spinner w-30px h-30px"></div></div>
	</div>
