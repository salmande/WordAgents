				...
				<td>
					...
					<div class="d-flex w-100">
						...
						<div>
							...
							<button type="button" class="btn btn-primary btn-sm mb-2 modal-submit_editing_order-trigger" data-toggle="modal" data-target="#modal-submit-<?php echo $order_id; ?>">Complete</button>
						</div>
					</div>
				</td>
				<?php endif; ?>
