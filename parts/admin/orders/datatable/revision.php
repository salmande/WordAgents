...
foreach( $orders as &$order)
{
	...
	$order['assigned_writers'] = empty($assigned_writers_array) ? '-' : implode("<br>", $assigned_writers_array);
	$order['assigned_editors'] = empty($assigned_editors_array) ? '-' : implode("<br>", $assigned_editors_array);
}
