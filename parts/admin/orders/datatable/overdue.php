...
$query_from 	= "orders";
$query_select 	= "*";
$query_where	= "((UNIX_TIMESTAMP() > writer_submit_time_end AND status='17') OR (UNIX_TIMESTAMP() > editor_claim_time_end AND status='12'))";
...
foreach( $orders as &$order)
{
	...
	$overdue_timestamp = ($order_status == 17) ? $order['writer_submit_time_end'] : $order['editor_claim_time_end'];
